...
namespace DeveloperTest.Migrations
{
    ...
    [Migration("20200804214359_AddCustomerJobRelationShip")]
    partial class AddCustomerJobRelationShip
    {
            ...
            modelBuilder.Entity("DeveloperTest.Database.Models.Job", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            JobId = 1,
                            Engineer = "Test",
                            When = new DateTime(2020, 8, 4, 23, 43, 58, 633, DateTimeKind.Local).AddTicks(2082)
                        });
                });
